...
#   plot-vcfstats /scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/wecare_nfe_kgen50.vchk -p /scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/
#
# Edit as necessary and recreate the plots by running
#   python /scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/plot.py
#
# Title abbreviations:
# 	 0 .. wecar .. /scratch/medgen/scripts/wecare_stat_01.17/interim_data/wecare_nfe_kgen50.vcf
#
...
dat = {}
with open('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/counts_by_af.snps.dat', 'rb') as f:
...
if plot_SNP_count_by_af:
	...
	if 0 in dat and len(dat[0])>2:
		ax1.plot([row[0]/100. for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='wecar')
		has_data = 1
	...
	if has_data:
		...
		plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/counts_by_af.snps.png')
		if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/counts_by_af.snps.pdf')
		plt.close()
...
dat = {}
with open('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/counts_by_af.indels.dat', 'rb') as f:
	reader = csv.reader(f, 'tab')
	for row in reader:
		if row[0][0] == '#': continue
		id = int(row[0])
...
if plot_Indel_count_by_af:
	...
	if has_data:
		...
		plt.subplots_adjust(bottom=0.2,left=0.1,right=0.95)
		plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/counts_by_af.indels.png')
		if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/counts_by_af.indels.pdf')
		plt.close()
...
dat = []
with open('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/tstv_by_af.0.dat', 'rb') as f:
	reader = csv.reader(f, 'tab')
	for row in reader:
...
if plot_tstv_by_af and len(dat)>2:
	...
	plt.title('wecar')
	plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/tstv_by_af.0.png')
	if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/tstv_by_af.0.pdf')
	plt.close()



dat = []
with open('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/tstv_by_qual.0.dat', 'rb') as f:
	reader = csv.reader(f, 'tab')
	for row in reader:
		if row[0][0] != '#': dat.append([float(x) for x in row])
...
if plot_tstv_by_qual:
	...
	plt.title('wecar')
	plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/tstv_by_qual.0.png')
	if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/tstv_by_qual.0.pdf')
	plt.close()



dat = []
with open('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/indels.0.dat', 'rb') as f:
	reader = csv.reader(f, 'tab')
	for row in reader:
		if row[0][0] != '#': dat.append([float(x) for x in row])
...
if plot_indel_dist and len(dat)>0:
	...
	plt.title('wecar')
	plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/indels.0.png')
	if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/indels.0.pdf')
	plt.close()
...
if plot_substitutions:
	...
	plt.title('wecar')
	plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/substitutions.0.png')
	if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/substitutions.0.pdf')
	plt.close()



dat = []
with open('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/depth.0.dat', 'rb') as f:
	reader = csv.reader(f, 'tab')
	for row in reader:
...
if plot_dp_dist:
	...
	plt.title('wecar')
	plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/depth.0.png')
	if pdf_plots: plt.savefig('/scratch/medgen/scripts/wecare_stat_01.17/interim_data/vcfstats/depth.0.pdf')
	plt.close()
