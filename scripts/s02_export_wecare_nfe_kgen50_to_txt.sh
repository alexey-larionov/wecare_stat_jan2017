...
#SBATCH -o s02_export_wecare_nfe_kgen50_to_txt.log
...
wecare_nfe_kgen50_vcf="${data_folder}/wecare_nfe_kgen50.vcf"

vcf_txt="${data_folder}/kgen50_vcf.txt"
vcf_log="${working_folder}/s02_kgen50_vcf.log"

gt_txt="${data_folder}/kgen50_gt.txt"
gt_log="${working_folder}/s02_kgen50_gt.log"

gq_txt="${data_folder}/kgen50_gq.txt"
gq_log="${working_folder}/s02_kgen50_gq.log"

dp_txt="${data_folder}/kgen50_dp.txt"
dp_log="${working_folder}/s02_kgen50_dp.log"
